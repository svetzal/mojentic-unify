...
tools: ['edit', 'runNotebooks', 'search', 'new', 'runCommands', 'runTasks', 'hexdocs/*', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo', 'extensions', 'todos', 'runSubagent', 'runTests']
---
