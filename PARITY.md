...
| **Tool Cancellation (AbortSignal)** | ✅ | 📝 | 📝 | ✅ | Idiomatic per language: asyncio.Event / AbortSignal |
...
| **Vendor-neutral event union** | ✅ | 📝 | 📝 | ✅ | RealtimeEvent + rawEvents() |
| **Raw event escape hatch** | ✅ | 📝 | 📝 | ✅ | `session.raw_events()` / `rawEvents()` |
| **Audio in/out streams** | ✅ | 📝 | 📝 | ✅ | numpy int16 (py) / Int16Array (ts) |
| **Tool cancellation on interrupt** | ✅ | 📝 | 📝 | ✅ | asyncio.Event / AbortSignal |
